...
const RADIO_REQUESTS: Record<RaceRadioSituation, readonly string[]> = {
  ...
  BRAKING_LOCKUP: ["Move my braking reference back for the wet line.", "Tell me where the standing water is before I arrive.", "I need a delta on the next braking zone.", "The front is locking again; give me more margin.", "Give me the safe line through this sector."],
